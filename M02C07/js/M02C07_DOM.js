...
imagen.setAttribute("src","img/cat03.jpg");
...
nuevolink.innerText="ver mas..."
nuevolink.setAttribute("href","https:/www.marca.com/");

//agregarlo a la página
var contenido = document.querySelector("#contenido");
contenido.appendChild(nuevoTitulo);
contenido.appendChild(nuevoParrafo);
contenido.appendChild(nuevolink);
